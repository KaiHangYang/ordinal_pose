...
eval_result_datas = [
        ...
        ("paper_3_1", "../evaluation/eval_result/10-22/gt_3_1/result_eval_30w.npy", [0.1, 0.21, 0.87, 0.5])
        ]
...
# eval_result_datas = [
        ...
        # ("paper_3_2", "../evaluation/eval_result/10-22/gt_3_2/result_eval_30w.npy", [0.1, 0.21, 0.87, 0.5])
        # ]

graph_save_dir = "/home/kaihang/Desktop/test_dir/3D/3_1"
...
if __name__ == "__main__":
    ...
    error_v.histogram(savers=savers, save_dir=graph_save_dir, colors=graph_colors, data_type=data_type, data_step=data_step, display_step=display_step, data_max=data_max, use_3d=use_3d)
    # error_v.data_error_line_chart(savers=savers, save_dir=graph_save_dir, colors=graph_colors, data_type=data_type, display_step=display_step * 500)
