...
class mConfigs(object):
    def __init__(self, conf_file, prefix):
        ...
        self.log_dir = os.path.join(config_parser.get("log", "base_dir"), "train/{}".format(self.prefix))

        # Dataset Settings
        self.range_file_dir = config_parser.get("dataset", "range_file_dir")
        self.h36m_train_range_file = os.path.join(self.range_file_dir, "train_range.npy")
        self.h36m_valid_range_file = os.path.join(self.range_file_dir, "valid_range.npy")
        self.lsp_range_file = os.path.join(self.range_file_dir, "lsp_range.npy")
        self.mpii_range_file = os.path.join(self.range_file_dir, "mpii_range.npy")
        ...
        self.model_dir = os.path.join(config_parser.get("model", "base_dir"), "{}".format(self.prefix))
        self.model_path_fn = lambda x: os.path.join(self.model_dir, "{}-{}".format(self.prefix, x))
    ...
    def printConfig(self):
        ...
        print("lsp_range_file: {}".format(self.lsp_range_file))
        print("lsp_img_path: {}".format(self.lsp_img_path_fn("{}")))
        print("lsp_lbl_path: {}".format(self.lsp_lbl_path_fn("{}")))

        print("mpii_range_file: {}".format(self.mpii_range_file))
