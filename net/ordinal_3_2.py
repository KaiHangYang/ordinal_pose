...
class mOrdinal_3_2(object):
    ...
    def __init__(self, nJoints, is_training, batch_size, img_size=256, coords_scale=1000.0, loss_weight=1000.0):
    ...
    def build_loss_gt(self, input_coords, lr, lr_decay_step, lr_decay_rate):
        ...
        self.loss = tf.nn.l2_loss(input_coords - self.result, name="coords_l2_loss") / self.batch_size * self.loss_weight
