...
# eval_1
# evaluation_models = [100000, 140000, 180000, 220000, 260000, 300000, 340000, 380000, 420000]

# eval_2
evaluation_models = [200000, 240000, 320000, 360000, 400000]
###############################################################
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for cur_model_iterations in evaluation_models:
            ...
            mean_depth_eval.save("../eval_result/ord_3_3/depth_eval_{}w_mean.npy".format(cur_model_iterations / 10000))
            mean_coords_eval.save("../eval_result/ord_3_3/coord_eval_{}w_mean.npy".format(cur_model_iterations / 10000))

            raw_depth_eval.save("../eval_result/ord_3_3/depth_eval_{}w_raw.npy".format(cur_model_iterations / 10000))
            raw_coords_eval.save("../eval_result/ord_3_3/coord_eval_{}w_raw.npy".format(cur_model_iterations / 10000))
