...
##################### Evaluation Configs ######################
configs = mConfigs("../eval.conf", "pose_net_br_nomid2hg")
configs.printConfig()
...
evaluation_models = [380000, 400000, 420000]
###############################################################
        ...
        for cur_model_iterations in evaluation_models:
            ...
            while not data_index.isEnd():
                ...
                for b in range(configs.batch_size):
                    ...
                    cur_img, cur_joints_2d, cur_joints_3d = preprocessor.preprocess(joints_2d=cur_joints_2d, joints_3d=cur_joints_3d, is_training=False, scale=cur_scale, center=cur_center, cam_mat=cur_cam_mat)
