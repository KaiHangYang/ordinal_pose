        ...
        for cur_model_iterations in evaluation_models:
            ...
            while not data_index.isEnd():
                ...
                for b in range(configs.batch_size):
                    ...
                    cur_img_flipped, _, _ = preprocessor.preprocess(joints_2d=cur_joints_2d_flipped, joints_zidx=cur_joints_zidx_flipped, bone_status=cur_bone_status_flipped, bone_relations=cur_bone_relations_flipped, is_training=False, bone_width=6, joint_ratio=6, bg_color=0.2, num_of_joints=configs.nJoints)
