...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        for cur_model_iterations in evaluation_models:
            ...
            pose_error_statistic.save("../eval_result/syn_3_2/result_eval_{}w.npy".format(cur_model_iterations / 10000))
            coords_eval.save("../eval_result/syn_3_2/coord_eval_{}w.npy".format(cur_model_iterations / 10000))
