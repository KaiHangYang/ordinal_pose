...
def parse_configs(t):
    ...
    log_dir = os.path.join(config_parser.get("log", "base_dir"), "train/3_1_" + train_type)
    ...
    model_dir = os.path.join(config_parser.get("model", "base_dir"), "3_1_{}".format(train_type))
    model_path_fn = lambda x: os.path.join(model_dir, config_parser.get("model", "prefix").format("3_1", train_type, x))
