...
configs = mConfigs("../train.conf", "pose_net_xyz_br")
configs.printConfig()
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            for b in range(batch_size):
                ...
                cur_img, cur_joints_2d, cur_joints_3d = preprocessor.preprocess(joints_2d=cur_joints_2d, joints_3d=cur_joints_3d, is_training=not is_valid, scale=cur_scale, center=cur_center, cam_mat=cur_cam_mat)
