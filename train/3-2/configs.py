...
def parse_configs(t):
    ...
    global coords_scale, loss_weight, nJoints, train_batch_size, valid_batch_size, img_size, learning_rate, lr_decay_rate, lr_decay_step, log_dir, train_range_file, valid_range_file, train_img_path_fn, train_lbl_path_fn, valid_img_path_fn, valid_lbl_path_fn, model_path_fn, model_dir, model_path, valid_iter, train_iter
...
def print_configs():
    ...
    print("coords_scale: {}\nloss_weight: {}\nnJoints: {}\ntrain_batch_size: {}\nvalid_batch_size: {}\nimg_size: {}\ntrain_iter: {}\nvalid_iter: {}".format(coords_scale, loss_weight, nJoints, train_batch_size, valid_batch_size, img_size, train_iter, valid_iter))
